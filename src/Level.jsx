...
export function BlockEnd({ position = [ 0, 0, 0 ] })
{
    ...
    return <group position={ position }> 
        ...
        <RigidBody name="hamburgi" type="fixed" colliders="hull" position={ [0, 0.25, 0] } restitution={ 0.2 } friction={ 0 }>
...
export function BlockSpinner({ position = [ 0, 0, 0 ] })
{
    ...
    return <group position={ position }> 
        ...
        <RigidBody name="spinir" ref={ obstacle } type="kinematicPosition" position={ [ 0, 0.3, 0 ] } restitution={ 0.2 } friction={ 0 }  >
...
export function BlockLimbo({ position = [ 0, 0, 0 ] })
{
    ...
    return <group position={ position }> 
        ...
        <RigidBody name="limbu" ref={ obstacle } type="kinematicPosition" position={ [ 0, 0.3, 0 ] } restitution={ 0.2 } friction={ 0 }  >
        <mesh  geometry={boxGeometry} material={ obstacleMaterial } scale={ [ 3.5, 0.3, 0.3 ] } castShadow receiveShadow />
        </RigidBody>
    </group>
}
...
export function BlockAxe({ position = [ 0, 0, 0 ] })
{
    ...
    return <group position={ position }> 
        ...
        <RigidBody name="machadu" ref={ obstacle } type="kinematicPosition" position={ [ 0, 0.3, 0 ] } restitution={ 0.2 } friction={ 0 }  >
...
{   
    return <>
    <RigidBody name="parede" type="fixed" restitution={ 0.2 } friction={ 0 }>
    <mesh 
